...
### autogen_tool:
Use Autogen agents to solve complex tasks.
Use "message" argument to send message.
Use "reset" argument with "true" to start with new autogen agent or "false" to continue with existing. For brand new tasks use "true", for followup conversation use "false". 
Explain to your autogen agent  what is the higher level goal and what is his part.
Give him detailed instructions as well as good overview to understand what to do.
**Example usage**:
~~~json
{
